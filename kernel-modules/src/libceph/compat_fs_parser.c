...
/* compat: security.h/namei.h/internal.h dropped along with fs_lookup_param() */
...
/* compat: fs_lookup_param() removed — needs struct fs_context / path lookup,
 * not backported. ceph/rbd never use blockdev/path/fd parameter types. */
